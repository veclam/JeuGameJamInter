...
{
	//This is a copy of UE:EditorAssetUtils::DeleteEmptyDirectories
	//TODO: This creates an exception when deleting an asset that is in the root folder of a Plugin
